...
pub use ckb_types::core::service::{PoolTransactionEntry, PoolTransactionReject};
...
pub struct NotifyController {
    ...
    reject_transaction_register: NotifyRegister<(PoolTransactionEntry, PoolTransactionReject)>,
    reject_transaction_notifier: Sender<(PoolTransactionEntry, PoolTransactionReject)>,
...
pub struct NotifyService {
    ...
    reject_transaction_subscribers:
        HashMap<String, Sender<(PoolTransactionEntry, PoolTransactionReject)>>,
...
impl NotifyService {
    ...
    fn handle_register_reject_transaction(
        &mut self,
        msg: Result<
            Request<String, Receiver<(PoolTransactionEntry, PoolTransactionReject)>>,
            RecvError,
        >,
    ) {
        match msg {
    ...
    fn handle_notify_reject_transaction(
        &mut self,
        msg: Result<(PoolTransactionEntry, PoolTransactionReject), RecvError>,
    ) {
        match msg {
            Ok(tx_entry) => {
...
impl NotifyController {
    ...
    pub fn subscribe_reject_transaction<S: ToString>(
        &self,
        name: S,
    ) -> Receiver<(PoolTransactionEntry, PoolTransactionReject)> {
